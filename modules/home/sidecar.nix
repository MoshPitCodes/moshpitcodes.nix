...
in
{
  ...
  # These are provided via overlays/sidecar.nix and overlays/td.nix
  # Sidecar: https://github.com/marcus/sidecar (Go TUI for AI-assisted development)
