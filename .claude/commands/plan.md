---
description: Creates a concise engineering implementation plan based on user requirements and saves it to .claude/plans directory
...
USER_PROMPT: $1
PLAN_OUTPUT_DIRECTORY: `.claude/plans/`
...
## TD Tasks
For TD (Task-Driven) workflow integration, these tasks should be created:
...
<continue with additional TD tasks as needed>
...
### 1. <First Task Name> (maps to TASK-1)
- <specific action>
- <specific action>

### 2. <Second Task Name> (maps to TASK-2)
- <specific action>
- <specific action>
