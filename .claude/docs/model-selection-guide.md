...
Complete guide to selecting the right AI model for Claude Code agents, with rationale for each agent's model assignment.
...
- Open a Linear issue in the Claude Code Components team
