...
**Description:** Personal NixOS system configuration supporting desktop, laptop, and VMware guest machines.
...
**Key Features:**
- Multi-host support (desktop, laptop, VMware guest)
...
The system includes automated daily backups of `~/Development` to the NAS (enabled for desktop and laptop hosts).
