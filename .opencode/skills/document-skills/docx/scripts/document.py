...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Claude Code", initials: str = "O"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Claude Code")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Claude Code")
